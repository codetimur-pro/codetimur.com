...
(function () {
  ...
  function drawBg() {
    ...
    ctx.lineTo(W, H);
    ctx.closePath();
    ctx.fillStyle = 'rgba(10,9,15,0.85)';
    ctx.fill();
    ctx.restore();
    ...
    ctx.quadraticCurveTo(W * 0.22, H * 0.68, W * 0.36, H * 0.56);
    ctx.quadraticCurveTo(W * 0.46, H * 0.47, W * 0.52, H * 0.45); /* пик */
    ctx.quadraticCurveTo(W * 0.60, H * 0.50, W * 0.70, H * 0.62);
    ctx.quadraticCurveTo(W * 0.82, H * 0.74, W * 0.93, H * 0.84);
    ctx.lineTo(W, H * 0.88);
    ctx.lineTo(W, H);
    ctx.closePath();
    ...
    ctx.quadraticCurveTo(W * 0.22, H * 0.68, W * 0.36, H * 0.56);
    ctx.quadraticCurveTo(W * 0.46, H * 0.47, W * 0.52, H * 0.45);
    ctx.quadraticCurveTo(W * 0.60, H * 0.50, W * 0.70, H * 0.62);
    ctx.quadraticCurveTo(W * 0.82, H * 0.74, W * 0.93, H * 0.84);
