...
const DIAG_CARDS = [{
  ...
  diagnosis: "Жёсткая привязка к результату. Излишнее давление на себя выжигает топливо и снижает силу действия."
}, {
  n: "04",
  signal: "Выгорание.",
  ...
  diagnosis: "Ты сошёл с пути истинной самореализации. Остановка в масштабе из-за отсутствия мотивации отдавать."
}];
const DiagCard = ({
  card,
  index
