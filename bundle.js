...
const DIAG_CARDS = [{
  ...
  diagnosis: "Подсознательные выгоды не делать. Страх ошибки и неизвестности парализует в действиях."
}, {
  n: "03",
  signal: "Действие через «надо».",
  sub: "Не хочу — но делаю.",
  diagnosis: "Жёсткая привязка к результату. Излишнее давление на себя выжигает топливо и лишает твои действия пробивной мощи."
}, {
  n: "04",
  signal: "Выгорание.",
  sub: "Не могу и не делаю. Нет сил.",
  diagnosis: "Слишком долго ехал на ручнике, действуя из жёсткого «надо»."
}, {
  n: "05",
  signal: "Низкая эффективность.",
  sub: "Делаю — но без результата.",
  diagnosis: "Нет внутренней веры в себя и в свои действия."
}, {
  n: "06",
  signal: "Потеря смысла.",
  sub: "Результат есть — но не радует.",
  diagnosis: "Ты сошёл с пути истинной самореализации. Остановка в масштабе из-за отсутствия мотивации созидать и отдавать."
}];
const DiagCard = ({
  card,
  index
...
const PROGRAM = [{
  ...
  level: "Уровень 1",
  title: "Изобилие",
  summary: "Показатель проводимости и удержания энергии.",
  body: "Переход от дефицита к состоянию чистой проводимости. Мы убираем подсознательные блоки, страх потери и внутренние конфликты. Расширение твоей личной ёмкости позволяет легко привлекать и удерживать денежную энергию, делая её естественным фоном жизни.",
  bullets: ["Расширение ёмкости", "Энергия денег", "Чистая проводимость"]
}, {
  n: "02",
  level: "Уровень 2",
  title: "Эффективность",
  summary: "Показатель мудрого управления и перераспределения энергии.",
  body: "Выход из суеты в абсолютную точность. Синхронизация жёсткой стратегии и состояния потока. Опора на твои истинные таланты, отсечение лишнего и построение автономной системы через сильную команду, второй мозг и внедрение ИИ.",
  bullets: ["Точность действий", "Система и команда", "Второй мозг и ИИ"]
}, {
  n: "03",
  level: "Уровень 3",
  title: "Масштаб",
  summary: "Показатель качества взаимодействия с миром и созидания.",
  body: "Выход на уровень глобального созидания. Твоя система работает автономно, высвобождая фокус для масштабных проектов и стратегических альянсов. Твоя энергия направлена исключительно на влияние, а миссия становится видимой всему миру.",
  bullets: ["Глобальное влияние", "Масштабные проекты", "Стратегические альянсы"]
}];
const ProgramItem = ({
  item,
  open,
